iris.ui(function(self) {
  ...
  function onBtnAddFeatureClick() {
    ...
    book.createFeature(self.setting('episode').id, {
      name: name,
      description: {motivation: 'Motivation', beneficiary: 'Beneficiary', expectedBehaviour: 'Expected behaviour'}
  ...
  function addFeatureItem(episode, feature, navigate) {
    ...
    self.ui('listFeatures', iris.path.ui.featureItem.js, {
      episode: episode,
      feature: feature,
      url: featureUrl
    }, self.APPEND);
